  ...
  >
    ...
    <div class="flex justify-between items-start mb-3">
      <div class="flex gap-3 items-center">
        ...
        <div
          class="w-10 h-10 bg-emerald-50 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform"
        >
        ...
        >
          <button
            ...
            class="p-1.5 text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700"
          ...
          <button
            ...
            class="p-1.5 text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20"
      ...
      <div
        class="bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 px-3 py-1 rounded-lg max-w-[150px]"
      >
        <p
    ...
    <div class="mb-4">
      <h3
        class="text-base font-bold text-slate-800 dark:text-slate-100 line-clamp-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors"
      >
        {{ template.title }}
      </h3>
      <p
    ...
    <div class="flex gap-2">
      <div
        class="flex-1 bg-slate-50 dark:bg-slate-700/50 border border-slate-100 dark:border-slate-600 ring-1 ring-slate-100 dark:ring-slate-700 px-3 py-2 rounded-xl flex flex-col items-center justify-center"
      >
        <span
          class="text-emerald-600 dark:text-emerald-400 font-extrabold text-base leading-none mb-1"
          >{{ template.questionsCount }}</span
        >
        <span
          class="text-[9px] text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wider"
          >Questões</span
        >
      </div>
      <div
