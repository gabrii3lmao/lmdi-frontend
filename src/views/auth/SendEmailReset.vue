  ...
  >
    ...
    >
      ...
      <form class="space-y-5" @submit.prevent="handleForgotPassword">
        <div
          v-if="message"
          class="p-5 rounded-2xl bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-100 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 text-sm flex flex-col gap-4 items-center text-center animate-in slide-in-from-bottom-2"
        >
          <div
